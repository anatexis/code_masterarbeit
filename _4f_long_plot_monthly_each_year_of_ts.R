# final calibration of daily values aggregated to monthly! (previously weekly) values
...
setwd("C:/Users/Russ/Desktop/master/plotfiles_Hofstetten/plot_monthly_each_year/")
